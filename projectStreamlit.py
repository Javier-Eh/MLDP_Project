...
def user_input_features():
    ...
    physical_activity = st.sidebar.slider('How many days in a week do u excercise?', options=[0,7,1])
    sleep = st.sidebar.slider('How many hours do you sleep a day?', options=[4,10,1])
